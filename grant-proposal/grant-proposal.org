...
*** 1: Convert a specific set of SQL tables to SPARQL (2 months)
...
*** 2: Test a machine learning algorithm using SPARQL, compare it to SQL (8 months)
To demonstrate the value addition of having well annotated semantic data, this research intends to test a machine learning algorithm using SPARQL, and compare it's performance with SQL. This test will be conducted in a reproducible way by following a set of simple rules outlined by [cite/t/c/:@sandve2013ten].
y
*** 3: Setup the results from (2) in Kenya (2 months)
