...
This will allow us to add African studies and data to GN using the latest methods, including homomorphic encryption of human data [cite:@mott2020private] and differential privacy [cite:@dwork2008differential;@nlnetVariationGraph].
...
Providing a new graph-based RDF data model with built-in relationships will make machine-based data mining possible[cite:@munoz2014using]. These methods are not new. Two successful very large and high performing RDF databases are Wikidata - the backend for Wikipedia - and Uniprot [cite:@erxleben2014introducing;@malyshev2018getting;@redaschi2009uniprot].
