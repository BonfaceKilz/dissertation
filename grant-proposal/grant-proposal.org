...
| Month         | Tasks                                                                  |
|---------------+------------------------------------------------------------------------|
| May -- Sep 22 | - Convert GN SQL and other data sources to RDF graph-database          |
|               | - Expose GN data through graph-database SPARQL endpoints               |
|---------------+------------------------------------------------------------------------|
| Oct -- Dec 22 | - Run a ML/AI study replicating one or more GN related                 |
|               | studies, and show that such data can be made available for ML/AI.      |
|               | - Host GN at KEMRI/Wellcome Trust to allow researchers                 |
...
|---------------+------------------------------------------------------------------------|
| Jan -- Mar 23 | - Assess ethical aspects of access to human data in the Kenyan context |
|               | - Reproduce selected studies that uses GN                              |
|---------------+------------------------------------------------------------------------|
| Apr -- May 23 | - Write a peer-reviewed publication on this work                       |
