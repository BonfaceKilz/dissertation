#+TITLE: Unlock biomedical data for health research in Africa using GeneNetwork as an example
...
The three intended deliverables for this research project are:
*** 1: Convert a section of the GN database to RDF to enrich it's semantic value to AI/ML tasks
...
*** 2: Reproduce GN related studies and show that it can be made available for ML/AI
...
*** 3: Replicate the new GN infrastracture that uses linked data in a data store in Kenya
...
| Month           | Tasks                                                                  |
|-----------------+------------------------------------------------------------------------|
| May -- Sep 2022 | - Convert GN SQL and other data sources to RDF graph-database          |
|                 | - Expose GN data through graph-database SPARQL endpoints               |
|-----------------+------------------------------------------------------------------------|
| Oct -- Dec 2022 | - Run a ML/AI study replicating one or more GN related                 |
